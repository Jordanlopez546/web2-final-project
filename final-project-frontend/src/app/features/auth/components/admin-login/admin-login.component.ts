        ...
        <mat-card class="auth-card admin-theme">
          <mat-card-header class="auth-header">
            <div class="header-content">
              ...
              <div class="header-text">
                ...
                <mat-card-subtitle>Access admin dashboard</mat-card-subtitle>
              </div>
            </div>
          </mat-card-header>
            ...
            <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" class="auth-form">
              ...
              <div class="form-actions">
                <button mat-raised-button type="submit" 
                  ...
                  <mat-icon style="color: white;" *ngIf="!isLoading">security</mat-icon>
                  <span style="color: white;" *ngIf="!isLoading">Admin Sign In</span>
          ...
          <mat-card-actions class="auth-actions">
            <div class="action-links">
              ...
              <button mat-button class="register-link" [routerLink]="['/auth/admin/register']">
            ...
            <div class="navigation-links">
              ...
              <button mat-stroked-button class="nav-btn student-btn" [routerLink]="['/auth/student/login']">
                Student Login
